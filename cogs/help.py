...
class Help(commands.Cog):
    ...
    # async def help(self, interaction: discord.Interaction, input: str):
    ...
    #                         emb = discord.Embed(title=f'Error', description="Sorry {}, you do not have permissions to do that!".format(interaction.message.author),
